...
import { Card, CardBody, Col, Container, Form, FormGroup, Input, Label, Row, CardImg, CardGroup, ListGroup, ListGroupItem } from 'reactstrap';
...
function UserInformation({ index, empty }) {
